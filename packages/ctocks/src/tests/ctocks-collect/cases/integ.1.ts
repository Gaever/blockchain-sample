...
const fromAddressCur2 = 'ach1fq43d60pgq6ug253nk7v7npx3d2c0anr8zrxwxhn43pwacts94hss7xfna';
...
const _in = {
  ...
  transactions: [
    ...
    },
    {
      ...
      fromAddress: fromAddressCur2,
      toAddress: rateToAddress(exchangeConfig.cur2, '1.2', exchangeConfig),
      amount: 5,
    },
  ],
...
const necessaryAmountCur2 = _in.transactions.filter(item => item.cur === exchangeConfig.cur2).reduce((sum, item) => sum + item.amount, 0);

_in.necessaryAmountCur1 = necessaryAmountCur1;
_in.necessaryAmountCur2 = necessaryAmountCur2;

const _out = {
  income: [
    { amount: '10', cur: exchangeConfig.cur1, status: 'proceded' },
    { amount: '5', cur: exchangeConfig.cur2, status: 'proceded' },
  ],
  orders: [
    { cur1: exchangeConfig.cur1, cur2: exchangeConfig.cur2, amount: '6', start_amount: '10', status: 'part' },
    { cur1: exchangeConfig.cur2, cur2: exchangeConfig.cur1, amount: '0', start_amount: '5', status: 'done' },
  ],
  deals: [{ cur1: exchangeConfig.cur1, cur2: exchangeConfig.cur2, amount1: '5', amount2: '4', rate: '1.2', status: 'new' }],
  curSeries: [{ opening_price: '1.2', highest_price: '1.2', lowest_price: '1.2', closing_price: '1.2', volume_1: '4', volume_2: '5' }],
};
