...
_set(enviroment, 'stockConfigRecord.config_json.exchangeConfig.xch.fees.makerFee.percent', '0');
_set(enviroment, 'stockConfigRecord.config_json.exchangeConfig.ach.fees.makerFee.percent', '0');
_set(enviroment, 'stockConfigRecord.config_json.exchangeConfig.xch.fees.takerFee.percent', '0');
_set(enviroment, 'stockConfigRecord.config_json.exchangeConfig.ach.fees.takerFee.percent', '0');

_set(enviroment, 'stockConfigRecord.config_json.exchangeConfig.xch.fees.makerFee.fixed', '2');
_set(enviroment, 'stockConfigRecord.config_json.exchangeConfig.ach.fees.makerFee.fixed', '2');
_set(enviroment, 'stockConfigRecord.config_json.exchangeConfig.xch.fees.takerFee.fixed', '3');
_set(enviroment, 'stockConfigRecord.config_json.exchangeConfig.ach.fees.takerFee.fixed', '3');

_set(enviroment, 'stockConfigRecord.config_json.exchangeConfig.xch.fees.transactionFee', '1');
_set(enviroment, 'stockConfigRecord.config_json.exchangeConfig.ach.fees.transactionFee', '1');
...
const testCase: TCase = {
  title: 'include blockchain fee, having fixed fee',
  enviroment,
  in: {
  ...
  out: {
    aggregatedCur1Amount: String(+process.env.TEST_XCH_START_AMOUNT - 2),
    aggregatedCur2Amount: String(+process.env.TEST_ACH_START_AMOUNT - 2),
    mainAddress1Amount: String(+process.env.TEST_XCH_START_AMOUNT - 50),
    mainAddress2Amount: String(+process.env.TEST_ACH_START_AMOUNT - 50),
    aggregatedStock1Amount: '0',
    aggregatedStock2Amount: '0',
