...
import { TestCase } from '../broker.func.test';
...
const cur1StockHolderPuzzleHash = addressToPuzzleHash(process.env.CUR1_STOCK_HOLDER_ADDRESS);
const cur2StockHolderPuzzleHash = addressToPuzzleHash(process.env.CUR2_STOCK_HOLDER_ADDRESS);
...
function getTestCase(stockId: number): ReturnType<TestCase['getTestCase']> {
  ...
  const outcomes = [
    ...
    },
    {
      ...
      amount: '1',
      transaction_fee: '0',
      client_puzzle_hash: null,
      stock_holder_puzzle_hash: cur2StockHolderPuzzleHash,
      cur: 'ach',
      status: 'created',
      payback_fee: null,
    },
    {
      ...
      transaction_fee: '0',
      client_puzzle_hash: null,
      stock_holder_puzzle_hash: cur1StockHolderPuzzleHash,
      cur: 'hdd',
      status: 'created',
      payback_fee: null,
    },
