...
_set(config, 'config_json.exchangeConfig.hdd.orderLifetimeMs', '1000');
_set(config, 'config_json.exchangeConfig.ach.orderLifetimeMs', '1000');
...
function getTestCase(stockId: number): ReturnType<TestCase['getTestCase']> {
  ...
  const orders = [
    {
      created_at: new Date(buyerRate1TxTimestamp * 1000),
      expires_at: new Date(buyerRate1TxTimestamp * 1000 + 1000),
      stock_id: stockId,
      amount: '10',
      start_amount: '10',
      rate: '1',
    ...
    {
      created_at: new Date(sellerRate2TxTimestamp * 1000),
      expires_at: new Date(sellerRate2TxTimestamp * 1000 + 1000),
      stock_id: stockId,
      amount: '10000',
      start_amount: '10000',
      rate: '2',
