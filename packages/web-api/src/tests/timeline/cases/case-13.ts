...
const testCase: TestCase = {
  ...
  out: {
    candles: [
      ...
      ...emptyCandles(new Date('2021-12-27T00:26:00.000Z').getTime(), new Date('2021-12-27T00:27:00.000Z').getTime(), 1000 * 60, 15),
      {
        close: 30,
        high: 50,
        low: 7,
      ...
      ...emptyCandles(new Date('2021-12-27T00:29:00.000Z').getTime(), new Date('2021-12-27T00:30:00.000Z').getTime(), 1000 * 60, 30),
    ],
    volume: [
