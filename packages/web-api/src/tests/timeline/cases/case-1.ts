...
const testCase: TestCase = {
  ...
  out: {
    candles: emptyCandles(flooredNow.getTime() - 1000 * 60 * 60 * 24, flooredNow.getTime(), 1000 * 60, 1),
    volume: emptyVolumes(flooredNow.getTime() - 1000 * 60 * 60 * 24, flooredNow.getTime(), 1000 * 60),
  },
};
