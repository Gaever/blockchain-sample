...
const testCase: TCase = {
  _in: {
    deal: {
      ...
      seller_amount_in_cur2: new BigNumber(140),
      buyer_amount_in_cur1: new BigNumber(90),
      rate: new BigNumber('1.56'),
      seller_fee_in_cur2: new BigNumber(130),
      buyer_fee_in_cur1: new BigNumber(80),
      seller_order_id: 1,
      buyer_order_id: 2,
      status: 'new',
