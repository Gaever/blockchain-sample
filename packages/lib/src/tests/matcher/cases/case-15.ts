...
const newOrder = createOrder('237000', '0.75', new Date(4), 'xch', 'ach');
const sellIn = [
...
const testCase: TestCase = {
  ...
  out: {
    ...
    affectedOrders: [
      ...
      { ...newOrder, status: 'part', amount: new BigNumber(889) },
    ],
    sell: [...sellIn, { ...newOrder, status: 'part', amount: new BigNumber(889) }],
    buy: [buyIn[2]],
  },
};
